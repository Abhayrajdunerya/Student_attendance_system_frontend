          ...
          <section class="text-gray-600 body-font">
            <div class="px-5 py-24 mx-auto">
              ...
              <div class="flex flex-wrap -m-2">
                {allStudents.length ? allStudents.map((student, i) => <ListCard key={i} name={student.name} rollNo={student.roll_no} email={student.email} gender={student.gender} />) : <div>No students found</div>}
...
export default ListStudentsTeacher